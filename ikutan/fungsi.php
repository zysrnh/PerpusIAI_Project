...
class paging {
	 ...
	 function getPagingkatfoto($jumlah, $pg, $stg, $kid) {
      ...
      if ($this->rowperpage<$jumlah) {
        ...
        if ($allpage>1) {
		 ...
		 function getPagingproduk($jumlah, $pg, $stg) {
        ...
        if ($allpage>1) {
          ...
          if ($pg>1) {
            if ($pg==$minpage) {
              ...
              $rtn .= "<a class=\"nextpage\" href=\"produk/".($stg-1)."/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            } else {
                if (($pg-1) == 1){
                    $newoffset = 0;
              ...
              $rtn .= "<a class=\"nextpage\" href=\"produk/$stg/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            }
          }
          for ($i=$minpage;$i<=$maxpage;$i++) {
            ...
            if ($i==$pg) {
              ...
              $rtn .= "<a href=\"produk/$stg/$newoffset/pg=".$i."\" title='Page $i'>$i</a> | ";
            }
          }
          if ($pg<=$maxpage) {
            if ($pg==$maxpage && $stg<$allstg) {
              $rtn .= " <a class=\"nextpage\" href=\"produk/".($stg+1)."/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            } elseif ($pg<$maxpage) {
              $rtn .= " <a class=\"nextpage\" href=\"produk/$stg/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            }
          }
          if ($stg<$allstg) {
              $rtn .= "<a class=\"nextstage\" href=\"produk/".($stg+1)."/".(($maxpage)*$this->rowperpage)."/pg=".($maxpage+1)."\"  title='Page $i'> &raquo;&raquo;&raquo;</a> | ";
              }
          $rtn = substr($rtn,0,strlen($rtn)-3);
          $rtn .= "</td></tr></table>";
          return $rtn;
	...
	function getPagingprodukcari($jumlah, $pg, $stg, $search) {
        ...
        if ($allpage>1) {
          ...
          if ($pg>1) {
            if ($pg==$minpage) {
              ...
              $rtn .= "<a class=\"nextpage\" href=\"produk/".$urlxtopik."/".($stg-1)."/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            } else {
                if (($pg-1) == 1){
                    $newoffset = 0;
              ...
              $rtn .= "<a class=\"nextpage\" href=\"produk/".$urlxtopik."/$stg/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            }
          }
          for ($i=$minpage;$i<=$maxpage;$i++) {
            ...
            if ($i==$pg) {
              ...
              $rtn .= "<a href=\"produk/".$urlxtopik."/$stg/$newoffset/pg=".$i."\" title='Page $i'>$i</a> | ";
            }
          }
          if ($pg<=$maxpage) {
            if ($pg==$maxpage && $stg<$allstg) {
              $rtn .= " <a class=\"nextpage\" href=\"produk/".$urlxtopik."/".($stg+1)."/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            } elseif ($pg<$maxpage) {
              $rtn .= " <a class=\"nextpage\" href=\"produk/".$urlxtopik."/$stg/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            }
          }
          if ($stg<$allstg) {
              $rtn .= "<a class=\"nextstage\" href=\"produk/".$urlxtopik."/".($stg+1)."/".(($maxpage)*$this->rowperpage)."/pg=".($maxpage+1)."\"  title='Page $i'> &raquo;&raquo;&raquo;</a> | ";
              }
          $rtn = substr($rtn,0,strlen($rtn)-3);
          $rtn .= "</td></tr></table>";
          return $rtn;
	...
	function getPagingteam($jumlah, $pg, $stg) {
        ...
        if ($allpage>1) {
          ...
          if ($pg>1) {
            if ($pg==$minpage) {
              ...
              $rtn .= "<a class=\"nextpage\" href=\"team/".($stg-1)."/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            } else {
                if (($pg-1) == 1){
                    $newoffset = 0;
              ...
              $rtn .= "<a class=\"nextpage\" href=\"team/$stg/".$newoffset."/pg=".($pg-1)."\"  title='Page $i'>&laquo; Previous</a> | ";
            }
          }
          for ($i=$minpage;$i<=$maxpage;$i++) {
            ...
            if ($i==$pg) {
              ...
              $rtn .= "<a href=\"team/$stg/$newoffset/pg=".$i."\" title='Page $i'>$i</a> | ";
            }
          }
          if ($pg<=$maxpage) {
            if ($pg==$maxpage && $stg<$allstg) {
              $rtn .= " <a class=\"nextpage\" href=\"team/".($stg+1)."/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            } elseif ($pg<$maxpage) {
              $rtn .= " <a class=\"nextpage\" href=\"team/$stg/".(($pg)*$this->rowperpage)."/pg=".($pg+1)."\"  title='Page $i'>Next &raquo;</a> | ";
            }
          }
          if ($stg<$allstg) {
              $rtn .= "<a class=\"nextstage\" href=\"team/".($stg+1)."/".(($maxpage)*$this->rowperpage)."/pg=".($maxpage+1)."\"  title='Page $i'> &raquo;&raquo;&raquo;</a> | ";
              }
          $rtn = substr($rtn,0,strlen($rtn)-3);
          $rtn .= "</td></tr></table>";
          return $rtn;
