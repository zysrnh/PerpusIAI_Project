...
$login .= '<p>Silahkan login dengan memasukkan username dan password yang sudah anda daftarkan, jika merasa belum mendaftar silahkan klik tulisan Daftar.</p><form method="post" action="">
<table width=100%>
  <tr>
