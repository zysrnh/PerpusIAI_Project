...
createthumbs("images/testi/", "images/testi/thumb/", "$foto", 80);
...
$query = $koneksi_db->sql_query ("SELECT * FROM `mod_data_testi` WHERE status='1' $SORT_SQL LIMIT $offset, $limit");
...
$content .= '	<br/><div class="col-lg-12" style="margin-bottom:10px;">

	<img src="images/testi/thumb/'.$data['foto'].'" class="img-thumbnail" alt="'.$data['nama'].'" style="float:left;">

							<div class="testimonial testimonial-style-4" style="margin-left:140px;">
								<br/>
									'.$data['ket'].'<br/><strong>'.$data['nama'].'</strong><br/>'.$data['email'].'
...
$content .= '
	<br/><div class="col-lg-12" style="margin-bottom:10px;">
